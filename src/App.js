    ...
    <div style={{...styles.a4Sheet, margin: 0, boxShadow: 'none'}}>
      ...
      <table className="excel-table">
        ...
        <tbody>{data.rows.map((r, i) => {
            ...
            return (
              <tr key={i}>
                <td style={{textAlign:'center', fontSize:'12px', boxSizing:'border-box', padding:'7px 0'}}>{i+1}</td>
                <td style={{textAlign:'left', padding:'7px 0 8px 10px', fontSize:'12px', boxSizing:'border-box'}}>{r.desc}</td>
                <td style={{textAlign:'center', fontSize:'12px', boxSizing:'border-box', padding:'7px 0'}}>{r.unit}</td>
                <td style={{textAlign:'center', fontSize:'12px', boxSizing:'border-box', padding:'7px 0'}}>{r.qty}</td>
                <td style={{textAlign:'center', fontSize:'12px', boxSizing:'border-box', padding:'7px 0'}}>{r.price}</td>
